...
final List<ModuleEntry> moduleManifest = [
  ...
  ModuleEntry(
    ...
    platformSupport: const ModulePlatformSupport(web: true),
  ...
  ModuleEntry(
    ...
    platformSupport: const ModulePlatformSupport(web: false),
  ...
  ModuleEntry(
    ...
    estimatedMinutes: 25,
    status: ModuleStatus.ready,
    // Disabled on every host until the module is reframed as a concrete OTG workflow.
    platformSupport: const ModulePlatformSupport(
      nativePlatforms: {},
      web: false,
    ),
  ...
  ModuleEntry(
    ...
    // Android uses file_selector and requires real-device provider validation.
    platformSupport: const ModulePlatformSupport(
      nativePlatforms: {
        TargetPlatform.android,
        TargetPlatform.macOS,
  ...
  ModuleEntry(
    ...
    // Android/macOS use official video_player backends; Windows uses video_player_win.
    platformSupport: const ModulePlatformSupport(
      nativePlatforms: {
        TargetPlatform.android,
        TargetPlatform.macOS,
